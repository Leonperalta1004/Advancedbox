...
export class ColorConfig {
        ...
        "dark classic": `
			:root {
				...
				--black-piano-key: #444;
					...
					--pitch3-secondary-channel: #ff4d00;
					--pitch3-primary-channel:   #ff4d00;
					--pitch3-secondary-note:    #ff824d;
					--pitch3-primary-note:      #ff824d;
					--pitch4-secondary-channel: #00ff00;
					--pitch4-primary-channel:   #00ff00;
					--pitch4-secondary-note:    #26ff26;
					--pitch4-primary-note:      #26ff26;
					--pitch5-secondary-channel: #ff00ff;
					--pitch5-primary-channel:   #ff00ff;
					--pitch5-secondary-note:    #ff80ff;
					--pitch5-primary-note:      #ff80ff;
					--pitch6-secondary-channel: #5900ff;
					--pitch6-primary-channel:   #5900ff;
					--pitch6-secondary-note:    #ac80ff;
					--pitch6-primary-note:      #ac80ff;
					--pitch7-secondary-channel: #faff00;
					--pitch7-primary-channel:   #faff00;
					--pitch7-secondary-note:	#fcff80;
					--pitch7-primary-note:		#fcff80;
					--pitch8-secondary-channel: #ff0000;
					--pitch8-primary-channel:   #ff0000;
					--pitch8-secondary-note:    #ff8080;
					--pitch8-primary-note:      #ff8080;
					--pitch9-secondary-channel: #00ffb3;
					--pitch9-primary-channel:   #00ffb3;
					--pitch9-secondary-note:    #80ffd9;
					--pitch9-primary-note:		#80ffd9;
					--pitch10-secondary-channel:#8000ff;
					--pitch10-primary-channel:  #8000ff;
					--pitch10-secondary-note:   #bf80ff;
					--pitch10-primary-note:     #bf80ff;
					--noise1-secondary-channel: #ffffff;
					--noise1-primary-channel:   #ffffff;
					--noise1-secondary-note:    #ffffff;
					--noise1-primary-note:      #ffffff;
					--noise2-secondary-channel: #ff4d00;
					--noise2-primary-channel:   #ff4d00;
					--noise2-secondary-note:    #ffa680;
					--noise2-primary-note:      #ffa680;
					--noise3-secondary-channel: #0000ff;
					--noise3-primary-channel:   #0000ff;
					--noise3-secondary-note:    #8080ff;
					--noise3-primary-note:      #a600ff;
					--noise4-secondary-channel: #d280ff;
					--noise4-primary-channel:   #a600ff;
					--noise4-secondary-note:    #d280ff;
					--noise4-primary-note:      #d280ff;
					--noise5-secondary-channel: #00ff00;
					--noise5-primary-channel:   #00ff00;
					--noise5-secondary-note:    #80ff80;
					--noise5-primary-note:      #80ff80;
					--mod1-secondary-channel:   #000000;
					--mod1-primary-channel:     #000000;
					--mod1-secondary-note:      #000000;
					--mod1-primary-note:        #000000;
					--mod2-secondary-channel:   #000000;
					--mod2-primary-channel:     #000000;
					--mod2-secondary-note:      #000000;
					--mod2-primary-note:        #000000;
					--mod3-secondary-channel:   #000000;
					--mod3-primary-channel:     #000000;
					--mod3-secondary-note:      #000000;
					--mod3-primary-note:        #000000;
					--mod4-secondary-channel:   #000000;
					--mod4-primary-channel:     #000000;
					--mod4-secondary-note:      #000000;
    ...
    public static setTheme(name: string): void {
		...
		if (theme == undefined) theme = this.themes["edobox classic"];
